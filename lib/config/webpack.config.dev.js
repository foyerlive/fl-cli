...
var mode = process.env.foyerThemeMode ? 'theme' : 'dev';
var foyerPort = process.env.foyerDevelopmentPort || 9081;
...
module.exports = {
  entry: {
    [mode]: [
      process.env.foyerThemeMode ? '' : 'babel-polyfill',
      'webpack-hot-middleware/client?path=http://' + foyerHost + ':' + foyerPort + '/__webpack_hmr',
      './src/'
    ]
  },
  output: {
